...
const OwlMascot = ({ 
  ...
  const getSpeechBubbleStyle = () => {
    const baseStyle = {
      position: "absolute",
      width: isInCongrats ? "200px" : "180px",
      padding: isInCongrats ? "16px 20px" : "14px 18px",
      backgroundColor: "#58cc02",
      color: "white",
      borderRadius: isInCongrats ? "20px" : "18px",
      fontWeight: isInCongrats ? "700" : "600",
      fontSize: isInCongrats ? "14px" : "13px",
      fontFamily: "'Nunito', 'Helvetica Neue', Arial, sans-serif",
      boxShadow: isInCongrats ? "0 4px 12px rgba(0,0,0,0.3)" : "0 3px 8px rgba(0,0,0,0.25)",
      userSelect: "none",
      pointerEvents: "none",
      lineHeight: 1.4,
      textAlign: "center",
      border: isInCongrats ? "3px solid #46a302" : "2px solid #46a302",
      zIndex: 10,
    };
